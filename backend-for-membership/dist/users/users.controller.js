...
let UsersController = class UsersController {
    ...
    async findUsersWithPagination(pageNum = 1, perPage = 10) {
...
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('pageNum', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Query)('perPage', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "findUsersWithPagination", null);
__decorate([
    (0, common_1.Get)(':id'),
